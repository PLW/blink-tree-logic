// bltree_database_catalog_entry_mongod.cpp
...
namespace mongo {
    ...
    IndexAccessMethod* BLTreeDatabaseCatalogEntry::getIndex(
        ...
        IndexCatalogEntry* index )
    {
        ...
        BLTree* blt = _engine->getIndex( collection->ns().ns(), desc->indexName(), order );

        std::auto_ptr<BLTreeSortedDataImpl> raw =
            new BLTreeSortedDataImpl( _engine->getDB(), cf, order );
